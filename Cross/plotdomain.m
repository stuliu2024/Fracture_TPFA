...
text(-0.08,0.5,'p_D=1','HorizontalAlignment','center','Color','k','FontSize',12)
text(1.08,0.5,'p_D=0','HorizontalAlignment','center','Color','k','FontSize',12)
text(0.5,-0.045,'q_N=0','HorizontalAlignment','center','Color','k','FontSize',12)
text(0.5,1.045,'q_N=0','HorizontalAlignment','center','Color','k','FontSize',12)
% points = [0.25, 0.5; 0.75, 0.5; 0.5, 0.25; 0.5, 0.75];
% text(points(1,1)-0.22, points(1,2), '(0.25, 0.5)', 'FontName', 'Times', 'FontSize', 12);
% text(points(2,1)+0.02, points(2,2), '(0.75, 0.5)', 'FontName', 'Times', 'FontSize', 12);
% text(points(3,1)-0.1, points(3,2)-0.05, '(0.5, 0.25)', 'FontName', 'Times', 'FontSize', 12);
% text(points(4,1)-0.1, points(4,2)+0.05, '(0.5, 0.75)', 'FontName', 'Times', 'FontSize', 12);

text(ax(1)-0.009, ax(1)-0.045, '0', 'FontName', 'Times', 'FontSize', 12');
text(ax(2)-0.009, ax(1)-0.045, '1', 'FontName', 'Times', 'FontSize', 12');
