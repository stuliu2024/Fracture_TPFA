...
text(0-50,300,{'p_D=','1013250Pa'},'HorizontalAlignment','center','Color','k','FontSize',12)
text(350,600+30,'q_N=0','HorizontalAlignment','center','Color','k','FontSize',12)
text(700+50,300,'p_D=0','HorizontalAlignment','center','Color','k','FontSize',12)
text(350,0-25,'q_N=0','HorizontalAlignment','center','Color','k','FontSize',12)

text(ax(1)-25, ax(1)-30, '0', 'FontName', 'Times', 'FontSize', 12');
text(ax(2)-25, ax(1)-30, '700', 'FontName', 'Times', 'FontSize', 12');
