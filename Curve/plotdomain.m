...
N_partition = 10007; t_start = 0; t_end = 2*pi; 
t_partition = linspace(t_start,t_end,N_partition)';
Radius = 1/3; x_center = 0.5+(rand-0.5)*1e-4; y_center = 0.5+(rand-0.5)*1e-4;
...
text(-0.08,0.5,'p_D=1','HorizontalAlignment','center','Color','k','FontSize',14)
text(1.08,0.5,'p_D=0','HorizontalAlignment','center','Color','k','FontSize',14)
text(0.5,-0.045,'q_N=0','HorizontalAlignment','center','Color','k','FontSize',14)
text(0.5,1.045,'q_N=0','HorizontalAlignment','center','Color','k','FontSize',14)
