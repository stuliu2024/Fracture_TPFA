...
actual_fracs_flux_info2(:,[10 11]) = repmat([1 0;1 0;0 1;0 1],size(actual_fracs_flux_info2,1)/4,1);
...
w_fracs = actual_fracs_flux_info2(:,3).*actual_fracs_flux_info2(:,4)./G.faces.areas(actual_fracs_face,:);
% w_fracs = G.faces.areas(actual_fracs_face,:)./actual_fracs_flux_info2(:,3).*actual_fracs_flux_info2(:,4);
w_fracs = abs(w_fracs);
