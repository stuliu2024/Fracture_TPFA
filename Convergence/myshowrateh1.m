function myshowrateh1(h1,err1,k1,opt1,str1,h2,err2,k2,opt2,str2)
...
% title(['Rate of convergence is h^{' num2str(r2,2) '}'],'FontSize', 18);
h_legend = legend(str1,['C_1h^{' num2str(r1,2) '}'],...
                  str2,['C_2h^{' num2str(r2,2) '}'],'LOCATION','Best');
