...
%              0.5-1e-9,0.5-1e-9,pi/2+pi/3,0.5-4e-8,1e-03,1e7
             ]; %xc,yc,angle,length,thickness,permeability  
         
% fractures = [0.5-1e-9,0.5-1e-9,0,   0.5-4e-8,0.5e-03,1e8;
%              0.5-1e-9,0.5-1e-9,pi/2,0.5-4e-8,0.5e-03,1e8;
%              0.5+1e-9,0.5+1e-9,0,   0.5-4e-8,0.5e-03,1e8;
%              0.5+1e-9,0.5+1e-9,pi/2,0.5-4e-8,0.5e-03,1e8;
%              ]; %xc,yc,angle,length,thickness,permeability  
...
%将上述结果直接组装起来,第一列表示裂缝在该单元的长度，第二列表示相应cos、sin值，第三列表示eplison*k_f，
%第四和五列表示[cos sin]值
